...
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{chapter2/fig/map_rev2.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{chapter2/fig/sw_bias_scatter_rev1.png}
...
outgoing SW radiation bias (Figure \ref{fig:sw_up_toa_time}) would change if
the cloud cover were increased by 5\% (Figure \ref{fig:cloud-cover-hist}),
