...
to evaluate SO cloud biases in HadGEM3.
\item Perform experimental simulations of HadGEM3 with the aim of
...
\begin{table}
\caption[Table of models and reanalyses]{
Table of models and reanalyses. Horizontal resolution is determined at 45$^\circ$S.
Legend: numerical weather prediction (NWP), general circulation model (GCM),
Antarctic Mesoscale Prediction System (AMPS),
European Centre for Medium-Range Weather Forecasts (ECMWF) Re-Analysis version 5 (ERA5),
Hadley Centre Global Environmental Model version 3--Global Coupled model 3.1 (HadGEM3--GC3.1),
Japanese 55-year reanalysis (JRA-55),
Modern-Era Retrospective analysis for Research and Applications (MERRA-2).
Global Atmosphere (GA) is the atmospheric component of HadGEM, based on
the atmospheric model Unified Model (UM).
}
\label{tab:1:models}
\centerline{
\begin{tabular}{lllll}
...
\hline
AMPS & NWP model & 3 h & 0.27$^\circ$ $\times$ 0.19$^\circ$ & 60\\
ERA5 & Reanalysis & 1 h & 0.25$^\circ$ $\times$ 0.25$^\circ$ & 37\\
HadGEM3--GC3.1 & GCM & 20 min. & 1.875$^\circ$ $\times$ 1.25$^\circ$ & 85\\
JRA-55 & Reanalysis & 6 h & 1.25$^\circ$ $\times$ 1.25$^\circ$ & 37\\
MERRA-2 & Reanalysis & 3 h & 0.625$^\circ$ $\times$ 0.50$^\circ$ & 72\\
\hline
\end{tabular}
}
\end{table}
...
\begin{tabular}{ll>{\raggedright}p{4cm}>{\raggedright}p{6cm}}
\hline
Instrument & Type & Quantities & Deployments\tabularnewline
\hline
iMet-1-AB-x & Radiosonde & p, T, RH, wind speed, wind direction & TAN1702, TAN1802\tabularnewline
Lufft CHM 15k & Ceilometer & Backscatter, CBH & TAN1502, HMNZS Wellington, TAN1702, NBP1704, TAN1802\tabularnewline
Metek MRR-2 & Micro rain radar & Radar reflectivity, RR & TAN1802\tabularnewline
Radiosonde (other) & Radiosonde & p, T, RH, wind speed, wind direction & NBP1704\tabularnewline
Sigma Space MiniMPL & Micropulse lidar & Backscatter, CBH, wind speed, wind direction & TAN1802\tabularnewline
Vaisala CL51 & Ceilometer & Backscatter, CBH & AA15\tabularnewline
\hline
\end{tabular}
}}
\end{table}
...
\begin{figure}[p]
\centerline{\includegraphics[width=\textwidth]{fig/tan1802_stats.pdf}}
\vspace{6pt}
...
The GERB project involves ERB instruments
