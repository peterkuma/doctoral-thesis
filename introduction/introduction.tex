...
(SR) simulated based on the New Zealand Earth System Model (NZESM) output in year 2017 at a wavelength of 532 nm.
...
Figure \ref{fig:surface-vs-spaceborne-lidar} shows that the scattering ratio
...
Due to the reasons outlined above, a combination of multiple passive, active,
...
Our objectives are adjacent to the New Zealand Deep South National
...
In addition to cloud base height, these measurements provide a wealth
...
below 2 km constitues the majority of cloud in the summertime in the SO
...
destabilised by relatively warm SST and subsquent formation of
