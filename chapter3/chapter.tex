...
The \textbf{simulate} command runs the lidar simulator described in Sect. \ref{sec:lidar-simulator}
...
Figures \ref{fig:examples}, \ref{fig:examples2}, \ref{fig:examples3} show images of backscatter for three separate days taken from
...
\caption{\textbf{(a)} Scheme showing the operation of the ALCF and \textbf{(b)} the processing commands.}
\label{fig:scheme}
\end{figure}
...
\caption{Map showing the location of sites. Data at three sites in New Zealand
...
\begin{table}[t]
\caption{Table of ALCs and their technical parameters. Power is calculated as Pulse $\times$ Pulse Repetition Frequency (PRF).}
\label{tab:alcs}
\centering
\scalebox{0.75}{
...
\begin{table}[t]
\caption{Location of sites and instruments. The time periods are inclusive.}
...
\begin{table}
\caption{Table of sensitivity tests of theoretical distribution assumption,
